...
public class Main {
	...
	private static void imprimeMenuGeral() {
		...
		System.out.println("9 - Mostrar Discussão");
		...
		while(opcao!=0) {
			...
			switch(opcao) {
				...
				case 8:
					...
					break;
				case 9:
					System.out.println("Informe o id da Materia que deseja ver uma discussão:");
	...
	private static void mostraDiscById(int idMateria) {
		...
		System.out.println("Informe o id da discussão:");
	...
	private static Resposta novaResposta() {
		...
		System.out.println("Informe o Título da sua resposta");
	...
	private static Post novoPost() {
		...
		System.out.println("Informe o conteúdo do post");
	...
	private static int getIdMateriaEscolhida() {
		//System.out.println("Informe o id da Materia que deseja cadastrar o usuário");
